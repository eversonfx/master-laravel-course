### Master Laravel Course

#### :open_book: About

Code made for the course "Master Laravel PHP for Beginners and Intermediate" by Piotr Jura

#### :bookmark_tabs: Instructions

It is necessary to migrate and seed the MySQL database
